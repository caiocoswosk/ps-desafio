...
@section('content')
<section class="color1bg">
  <ul id="slider-container">
    <li id="welcome-container">
      <div id="welcome-text" class="color2">
        <div>O <span id="melhor-text" class="gradient-text">MELHOR</span> LUGAR</div>
        <div>PARA DESBLOQUEAR</div>
        <div>SUAS <span id="memorias-text" class="gradient-text">MEMÓRIAS</span></div>
      </div>

      <div id="gameboy-container">
        <div id="gameboy-background"></div>
        <img id="pikachu" class="welcome-img floating" src="{{ asset("site/img/pikachu-perspective.gif") }}" alt="">
        <img id="gameboy" class="welcome-img floating" src="{{ asset("site/img/gameboy.png") }}" alt="">
      </div>
    </li>
  </ul>
</section>
